...
Abayernr_result_t Abayernr_Init_V2(Abayernr_Context_V2_t **ppAbayernrCtx, CamCalibDbContext_t *pCalibDb)
{
    ...
    *ppAbayernrCtx = pAbayernrCtx;
    ...
    pAbayernrCtx->list_bayernr_v2 = &pCalibDb->list_bayernr_v2;
	printf("%s(%d): bayernr list:%p %p\n", __FUNCTION__, __LINE__,
		&pCalibDb->list_bayernr_v2, pAbayernrCtx->list_bayernr_v2);
#endif
...
Abayernr_result_t Abayernr_GetProcResult_V2(Abayernr_Context_V2_t *pAbayernrCtx, Abayernr_ProcResult_V2_t* pAbayernrResult)
{
	...
	bayernr3D_fix_transfer_V2(&pAbayernrResult->st3DSelect, &pAbayernrResult->st3DFix, pAbayernrCtx->fRawnr_SF_Strength, &pAbayernrCtx->stExpInfo);
